name: "hunt-ladder"
description: "Анализ продукта через лестницу Ханта. Полная методология создания стратегии запуска Используй когда пользователь упоминает: анализ продукта, лестница Ханта, Хант."
ИНСТРУКЦИЯ: 
